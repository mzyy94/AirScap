...
スキャン開始前（プレスキャンチェック）とスキャンループ中で、ADF ステータスの参照オフセットが異なる。
...
| 44 | 4 | ADF Status (ループ中) | スキャンループ中の用紙有無 |
| 48 | 8 | Reserved | |
| 56 | 4 | ADF Status (初回) | スキャン開始前の用紙有無 |
| 60 | 12 | Reserved | ゼロ埋め |
...
| コンテキスト | チェックオフセット | 用紙あり例 | 用紙なし例 |
|-------------|-----------------|-----------|-----------|
| スキャン開始前 | オフセット 56 | `0xC0010000` | `0xC0000000` |
| スキャンループ中 | オフセット 44 | `0x00010000` | `0x00000000` |
